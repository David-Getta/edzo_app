...
TESTS="ActivitiesTest ActivitiesParseTest ActivitiesTimestampTest FoodsTest FoodsParseTest FoodsCompoundTest FoodsQuantityTest FoodsFitnessTest FoodsPieceTest
