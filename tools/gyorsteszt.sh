...
TESTS="ActivitiesTest ActivitiesParseTest ActivitiesTimestampTest ActivitiesBreakdownTest FoodsTest FoodsParseTest FoodsCompoundTest FoodsQuantityTest FoodsFitnessTest FoodsPieceTest
