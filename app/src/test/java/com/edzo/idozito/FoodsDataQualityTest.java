...
public class FoodsDataQualityTest {
    ...
    /**
     * A magyar konyha alapjait ismerjük – név szerint, egyesével.
     *
     * A lista nem díszlet: ezekre a szavakra tényleg rákeres az ember, és
     * ha egy stem-szigorítás közben elveszik közülük egy, azt semmi más nem
     * fogja meg. Százötven fogás, magyar és nemzetközi vegyesen – a
     * hétköznapi étrend java.
     */
    @Test public void theHungarianKitchenIsCovered() {
        String[] dishes = {
                "lecsó",
                "paprikás krumpli",
                "túrós csusza",
