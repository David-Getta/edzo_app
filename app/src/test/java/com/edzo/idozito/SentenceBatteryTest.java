...
public class SentenceBatteryTest {
    ...
    @Test public void theStrengthSentencesStayAsTheyAre() {
        String[][] cases = {
                ...
                {"húzódzkodás 3x max", "—"},
                {"eveztem 3x10 50 kg", "Evezés 10@50/10@50/10@50"},
                {"jó edzés volt", "—"},
    ...
    @Test public void theWorkoutSentencesStayAsTheyAre() {
        String[][] cases = {
                ...
                {"5-8 km futás", "futas×1 39p/6,5km [1d+0]"},
                {"reggel és este 30-30 perc kondi", "kondi×2 30p [1d+0]"},
                {"45 perc kardió", "egyeb×1 45p [1d+0]"},
                {"síztem 30 percet", "si×1 30p [1d+0]"},
    ...
    @Test public void theMealSentencesStayAsTheyAre() {
        String[][] cases = {
                ...
                {"párizsi felvágott", "Párizsi / felvágott 50g"},
                {"macchiato", "Tejeskávé / cappuccino 250g"},
                {"hatalmas adag rizs", "Rizs (főtt) 200g"},
