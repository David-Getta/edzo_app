...
public class SettingsActivity extends Activity {
    ...
    void whatsNewSheet() {
        String[][] items = {
            ...
            {"🩹", "Megelőzés és rehab", "Boka-stabilitás, térd, derék, váll, golf- és teniszkönyök, nyak, csípő, csukló, talp, sípcsont, IT-szalag, Achilles – kész, 10–15 perces gyógytornász-ihletésű sorok a Nyújtás & mobilitás lapon."},
