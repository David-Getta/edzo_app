...
public class ProfileActivity extends Activity {
    ...
    EditText heightEt, weightEt, bodyFatEt, byEt, bmEt, bdEt;
    TextView bmiValue, bmiCat, ageLabel;
    ChartView chart;
    TextView chartInfo;
    ...
    void loadValues() {
        ...
        watch(heightEt, () -> { Profile.setHeight(this, intOf(heightEt)); updateBmi(); });
        watch(weightEt, this::updateBmi);
        Runnable saveBirth = () -> { Profile.setBirth(this, intOf(byEt), intOf(bmEt), intOf(bdEt)); updateAge(); };
    ...
    void updateBmi() {
        double bmi = Profile.bmi(intOf(heightEt), doubleOf(weightEt));
        if (bmi < 0) {
            bmiValue.setText("—");
