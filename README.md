...
- **Beállítás mondatból**: „3 kör 40 mp munka 20 mp pihenő”, „8x20/10",
  „tabata”, „emom 10 perc” – a teremben kapott edzésterv szövegként érkezik,
  nem csúszkaállásként
...
```bash
bash tools/gyorsteszt.sh      # ~364 teszt: ételfelismerés, időzítő-számítások,
