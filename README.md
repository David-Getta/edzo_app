...
- **295 étel** kcal- és fehérje-értékkel (a magyar konyha klasszikusaitól
...
- **Napi kihívás** 9 típusból, a szokásaidhoz igazodva (perc, kör, két edzés,
  km, ismétlés, étkezés, fehérje-cél, vízcél, lépésgyűjtés)
...
```bash
bash tools/gyorsteszt.sh      # ~259 teszt: ételfelismerés, időzítő-számítások,
